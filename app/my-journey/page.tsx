    ...
    <main className="min-lg:w-3/4">
        ...
        <div className="flex gap-2">
          <div className="border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
            <div className="flex gap-2 items-center">
              <Image src={"/icons/check.svg"} alt='check mark' width={22} height={22}/>
          ...
          <div className="border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
            <div className="flex gap-2 items-center">
              <Image src={"/icons/cap.svg"} alt='cap mark' width={22} height={22}/>
      ...
      <Accordion type="multiple">
        <AccordionItem value="recent">
          <AccordionTrigger className="font-bold text-2xl">Recent</AccordionTrigger>
          <AccordionContent>
            <CompanionList title="Recent" companions={sessionHistory} />
          </AccordionContent>
        </AccordionItem>
